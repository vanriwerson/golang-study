...
import (
	...
	jwt "github.com/dgrijalva/jwt-go" // alias para o pacote importado
)
...
func extrairToken(r *http.Request) string {
	...
	if len(strings.Split(token, " ")) == 2 { // verifica se o token tem o formato esperado
		return strings.Split(token, " ")[1]
	}
	return token
}

// valida o método utilizado para fazer a assinatura do token
