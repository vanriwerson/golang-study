...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNotoken {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é permitido alterar contas de outros usuários"))
		return
	}
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNotoken {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é permitido excluir contas de outros usuários"))
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é permitido alterar senhas de outros usuários"))
		return
	}
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("a senha atual fornecida está incorreta"))
		return
	}
